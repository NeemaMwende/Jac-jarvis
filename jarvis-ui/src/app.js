...
function app() {
  return __jacJsx(Router, {}, [__jacJsx("div", {}, [__jacJsx("nav", {}, [__jacJsx(Link, {"to": "/"}, ["Home"]), " | ", __jacJsx(Link, {"to": "/about"}, ["About"]), " | ", __jacJsx(Link, {"to": "/contact"}, ["Contact"])]), __jacJsx(Routes, {}, [__jacJsx(Route, {"path": "/", "element": __jacJsx(Home, {}, [])}, []), __jacJsx(Route, {"path": "/about", "element": __jacJsx(About, {}, [])}, []), __jacJsx(Route, {"path": "/contact", "element": __jacJsx(Contact, {}, [])}, [])])])]);
}
